...
const translations = {
  en: {
    ...
    "dashboard.searchPlaceholder": "Search with AI suggestions...",
    ...
    "dashboard.joinedDate": "Joined Date",
    ...
    "dashboard.lastBooking": "Last Booking",
    "dashboard.totalBookings": "Total Bookings",
    "dashboard.earningsThisMonth": "Earnings This Month",
    "dashboard.newMessages": "New Messages",
    "dashboard.pendingReviews": "Pending Reviews",
    "dashboard.businessInfo": "Business Info",
    "dashboard.availability": "Availability",
    "dashboard.paymentPreferences": "Payment Preferences",
    "dashboard.add": "Add",
    "dashboard.save": "Save",
  ...
  ar: {
    ...
    "dashboard.providers": "مقدمو الخدمات",
    ...
    "dashboard.searchPlaceholder": "البحث بمساعدة الذكاء الاصطناعي...",
    "dashboard.notifications": "الإشعارات",
    "dashboard.myAccount": "حسابي",
    "dashboard.profile": "الملف الشخصي",
    "dashboard.logout": "تسجيل الخروج",
    "dashboard.totalUsers": "إجمالي المستخدمين",
    "dashboard.activeProviders": "مقدمو الخدمات النشطون",
    "dashboard.bookingsToday": "حجوزات اليوم",
    "dashboard.revenue": "الإيرادات",
    "dashboard.pendingVerifications": "التحققات المعلقة",
    ...
    "dashboard.contactInfo": "معلومات الاتصال",
    "dashboard.lastBooking": "آخر حجز",
    "dashboard.totalBookings": "إجمالي الحجوزات",
    "dashboard.earningsThisMonth": "أرباح هذا الشهر",
    "dashboard.newMessages": "رسائل جديدة",
    "dashboard.pendingReviews": "تقييمات معلقة",
    "dashboard.businessInfo": "معلومات العمل",
    "dashboard.availability": "التوافر",
    "dashboard.paymentPreferences": "تفضيلات الدفع",
    "dashboard.add": "إضافة",
    "dashboard.save": "حفظ",
    "dashboard.pause": "إيقاف مؤقت",
